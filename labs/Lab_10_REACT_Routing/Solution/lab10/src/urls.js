const getUrl = (id) => {
    const images = [
        ...
        "https://example.com/api/fixedParameter",
        ...
        "https://sun9-31.userapi.com/impg/GmX6-et3jtkLLEXuhdM6aGPSH9jFliUx0aut3w/HiPdpjTmkckk.jpg?size=500x500&quality=96&sign=fadcb8ac7a3e4afb8b2ebbe59315f78c&c_uniq_tag=tMQpTpYRr1xXpOc9cZRy4T7Yx7lH93jmqnBg5hN0QwU&type=album",
    ...
    if (id >= 1 && id <= images.length) {
        ...
        return "https://placeholder.com/500";
    }
};
